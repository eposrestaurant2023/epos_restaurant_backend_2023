...
def get_columns():
	...
	columns.append({'fieldname':'NAME','label':"Doc #",'fieldtype':'Link','options':'Ticket Booking','align':'center','width':140})
	...
	columns.append({'fieldname':'departure','label':"Departure Date",'fieldtype':'Datetime','align':'center','width':180})
