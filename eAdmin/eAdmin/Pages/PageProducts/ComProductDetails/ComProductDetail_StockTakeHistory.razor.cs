    ...
    { 
        ...
        public string ControllerApi
        {
            get
            {
                ...
                string url = $"{controller_api}?$select=id,created_by,created_date,unit,quantity,cost,total_amount,sub_total,stock_take_id&";
                url += $"$expand=stock_take($select=id,created_by,created_date,is_fulfilled,business_branch_id,stock_location_id,document_number,stock_take_date,reference_number;$expand=business_branch($select=id,business_branch_name_en,business_branch_name_kh),stock_location($select=id,stock_location_name))";
