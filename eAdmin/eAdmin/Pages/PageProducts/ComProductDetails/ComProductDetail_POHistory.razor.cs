...
{
    public class POProductDetailHistoryBase : PageCore
    { 
        ...
        public string StateKey
        {
            get
            {
                ...
                return "STOPOProdyctsaledmRGrRwd5021D20154coN" + gv.current_login_user.id + product_id.ToString(); //Storage and Session Key  
            }
        }
