    ...
    { 
        ...
        public string ControllerApi
        {
            get
            {
                ...
                url += $"$expand=sale($select=id,sale_date;$expand=customer($select=id,customer_name_en,customer_name_kh),outlet($select=id,outlet_name_en,outlet_name_kh),business_branch($select=business_branch_name_en,business_branch_name_kh,id)),unit($select=unit_name,id)";
