...
{
    public class POPaymentHistoryBase : PageCore
    { 
        ...
        public string ControllerApi
        {
            get
            {
                ...
                url += $"$expand=purchase_order,payment_type";
        ...
        public async Task LoadData(string api_url="")
        {
            ...
            if (resp.IsSuccess)
            {
                models = JsonSerializer.Deserialize<List<PurchaseOrderPaymentModel>>(resp.Content.ToString());
