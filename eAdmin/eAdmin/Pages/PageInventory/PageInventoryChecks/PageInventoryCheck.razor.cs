...
{
    public class PageInventoryCheckBase:PageCore
    {
        public List<InventoryCheckModel> models = new List<InventoryCheckModel>();
        public InventoryCheckModel model = new InventoryCheckModel();
        public int TotalRecord = 0;

        string controller_api = "InventoryCheck";
        ...
        public string StateKey
        {
            get
            {
                ...
                return "ENdsfssg9hUndmRGPUInventoryCheck09830212" + gv.current_login_user.id; //Storage and Session Key  
            }
        }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (state.page_title == "")
            {
                state.page_title = "Inventory Check";
                var default_view = gv.GetDefaultModuleView("page_inventory_check");
        ...
        public async Task LoadData(string api_url = "")
        {
            ...
            if (resp.IsSuccess)
            {
                models = JsonSerializer.Deserialize<List<InventoryCheckModel>>(resp.Content.ToString());
        ...
        public async Task OnDelete(InventoryCheckModel p)
        {
            p.is_loading = true;
