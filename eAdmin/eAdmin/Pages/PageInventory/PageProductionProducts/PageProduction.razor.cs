...
namespace eAdmin.Pages.PageInventory.PageProductionProducts
{
    public class PageProductionBase : PageCore
    {
        ...
        public string StateKey = "PROg9hUndmRGPUStockTake09830212"; //Storage and Session Key      
        ...
        public async Task LoadData(string api_url = "")
        {
            ...
            if (resp.IsSuccess)
            {
                models = JsonSerializer.Deserialize<List<ProductionModel>>(resp.Content.ToString());
