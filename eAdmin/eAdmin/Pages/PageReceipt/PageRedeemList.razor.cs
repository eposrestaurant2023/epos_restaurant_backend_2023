    ...
    public class ComRedeemBase : PageCore
    {
        ...
        public string ControllerApi
        {
            get
            {
                ...
                url += $"$select=id,product_id,sale_id,total_amount,station_name_en,station_name_kh,station_id,quantity,price,seat_number,is_redeem_park,park_note,park_expired_date";
