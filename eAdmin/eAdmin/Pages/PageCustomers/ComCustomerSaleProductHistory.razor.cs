    ...
    { 
        ...
        public string ControllerApi
        {
            get
            {
                ...
                string url = $"{controller_api}?$select=id,sale_id,quantity,price,sale_product_discount_amount,total_tax_amount,total_amount,created_date,created_by,portion_name,&";
