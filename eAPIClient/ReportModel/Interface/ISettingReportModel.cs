...
{
    public interface ISettingReportModel
    {
        ...
        public bool close_working_day_summary_include_sale_transaction { get; set; }
        public bool close_cashier_shift_summary_include_sale_transaction { get; set;} 
    } 
}
