...
namespace eShareModel
{
    public class TaxRuleModel
    {
        ...
        public bool calc_tax_1_after_discount { get; set; } = true;

        public bool calc_tax_2_after_discount { get; set; } = true;
        ...
        public bool calc_tax_3_after_discount { get; set; } = true;
