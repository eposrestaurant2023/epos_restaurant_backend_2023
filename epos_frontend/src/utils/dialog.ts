...
import ComSaleProductDiscountModal from '@/components/ComPrintWifiPasswordModal.vue'
...
export  const printWifiPasswordModal = createPromiseDialog<params, object>(ComSaleProductDiscountModal);
