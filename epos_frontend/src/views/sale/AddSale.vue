            ...
            <v-col cols="12" sm="5" md="5" lg="4" class="h-full pa-0">
                <div class="h-full grid px-1" style="grid-template-rows: max-content;">
                    ...
                    <div class="overflow-auto">
                        ...
                        <ComPlaceholder :is-not-empty="sale.getSaleProducts().length > 0" icon="mdi-cart-outline"
                            text="Empty Product">
                            ...
                            <div v-for="(g, index) in sale.getSaleProductGroupByKey()" :key="index">
                                <div class="bg-red-700 text-white flex items-center justify-between"
                                    ...
                                    <div><v-icon icon="mdi-account-outline" size="small"
                                            class="mr-1"></v-icon>{{ g.order_by }}</div>
                                </div>
                                <v-list class="!p-0">
                                    <v-list-item v-for="sp, index in sale.getSaleProducts(g)" :key="index"
                                        @click="sale.onSelectSaleProduct(sp)"
                                        ...
                                        <template v-slot:default>
                                            ...
                                            <div class="text-sm">
                                                <div class="flex">
                                                    <div class="grow">
                                                        <div> {{ sp.product_name }} {{ sp.sale_product_status }} <v-chip
                                                                size="x-small" color="error" variant="outlined"
                                                                v-if="sp.portion">{{ sp.portion }}</v-chip> <v-chip
                                                                v-if="sp.is_free" size="x-small" color="success"
                                                                variant="outlined">Free</v-chip></div>
                                                        <div>
                                                            {{ sp.quantity }} x
                                                        ...
                                                        <div class="text-xs pt-1">
                                                            <div v-if="sp.modifiers">
                                                                <span>{{ sp.modifiers }} (
                                                                    <CurrencyFormat
                                                                        :value="sp.modifiers_price * sp.quantity" />)
                                                                </span>
                                                            </div>
                                                            <div class="text-red-500" v-if="sp.discount > 0">
                                                                ...
                                                                <CurrencyFormat v-else
                                                                    :value="parseFloat(sp.discount)" />
                                                            </div>
                                                            <v-chip color="blue" size="x-small"
                                                                v-if="sp.seat_number">Seat# {{
                                                                    sp.seat_number
                                                                }}</v-chip>
                                                ...
                                                <div v-if="sp.selected" class="-mx-1 flex pt-1">
                                                    <v-chip color="teal" class="mx-1 grow text-center justify-center"
                                                    ...
                                                    <v-chip
                                                        ...
                                                        color="teal" class="mx-1 grow text-center justify-center"
                                                        variant="elevated" size="small"
