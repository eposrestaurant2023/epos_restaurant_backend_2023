<template>
    <!-- <ComModal :mobileFullscreen="true" width="800px" @onClose="onClose" :hideCloseButton="true" :hideOkButton="true">
        <template #title>
            Change / Merge Table
        </template>
        <template #content>
...
<script setup>
import { ref, defineEmits, inject,changeTableSelectSaleOrderDialog } from '@/plugin'
