<template >
    <v-menu>
        ...
        <v-list>
            ...
            <v-list-item prepend-icon="mdi-printer-pos" :title="$t('Printer')"    @click="onSelectPrinter()">
            </v-list-item>
        </v-list>
    </v-menu>
    <v-dialog
        ...
        width="auto">
            <v-card title="Select Printers">
                ...
                <v-card-actions>
                <v-btn color="error"  @click="showDialogSelectPrinter = false">Close</v-btn>
...
<script setup>
import { defineProps, inject,ref,i18n } from '@/plugin'
