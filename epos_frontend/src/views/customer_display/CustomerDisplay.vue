            ...
            <v-col class="h-100vh !p-0" cols="12" xs="12" sm="4" md="4" lg="4" xl="4">
                <div class="h-full flex-col flex">
                    ...
                    <div class="summary bg-green-500 p-5"> 
                        ...
                        <div class=" flex">
                            <div> total Item: </div>
                            <div  class="b"><CurrencyFormat :value="data.grand_total * data.exchange_rate" :currency="gv.setting.pos_setting.second_currency_name" /></div>
                        </div> 
                    </div>
        ...
        <v-row class="h-full !m-0">
            ...
            <v-col class="h-100vh !p-0" cols="12" xs="12" sm="4" md="5" lg="5" xl="4">
                ...
                <div class="flex justify-evenly mt-6">
                        <div>
                            <div class="text-2xl">
                                <div><CurrencyFormat :value="data.grand_total" /></div>
                                <div><CurrencyFormat :value="data.grand_total * data.exchange_rate" :currency="gv.setting.pos_setting.second_currency_name" /></div>
                            </div>
                ...
                <div class="text-center text-gray-500">Paid amount: <CurrencyFormat :value="data.grand_total" /> / <CurrencyFormat :value="data.grand_total * data.exchange_rate" :currency="gv.setting.pos_setting.second_currency_name" />
                    </div>
