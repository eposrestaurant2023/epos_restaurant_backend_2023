...
namespace eAPI.Migrations
{
    ...
    [Migration("20230217070526_block_to_business_branch_ids")]
    partial class block_to_business_branch_ids
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eModels.BusinessBranchModel", b =>
                {
                    ...
                    b.Property<string>("business_branch_code")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");
            ...
            modelBuilder.Entity("eModels.DiscountPromotionItemModel", b =>
                {
                    ...
                    b.ToTable("tbl_discount_promotion_item");
                });
            ...
            modelBuilder.Entity("eModels.DiscountPromotionModel", b =>
                {
                    ...
                    b.Property<bool>("is_base_on_hour")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("tbl_discount_promotion");
                });
            ...
            modelBuilder.Entity("eModels.HistoryModel", b =>
                {
                    ...
                    b.Property<string>("sale_payments")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");

                    b.Property<string>("sale_products")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");
            ...
            modelBuilder.Entity("eModels.InventoryCheckModel", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("inventory_check_type")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");
                    ...
                    b.Property<string>("product_categories")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");
            ...
            modelBuilder.Entity("eModels.InventoryCheckProductModel", b =>
                {
                    ...
                    b.Property<decimal>("consume_quantity")
                        .HasColumnType("decimal(19,8)");
                    ...
                    b.Property<decimal>("diference_quantity")
                        .HasColumnType("decimal(19,8)");

                    b.Property<decimal>("expected_amount")
                        .HasColumnType("decimal(19,8)");

                    b.Property<decimal>("expected_quantity")
                        .HasColumnType("decimal(19,8)");

                    b.Property<decimal>("initial_quantity")
                        .HasColumnType("decimal(19,8)");

                    b.Property<DateTime>("inventory_check_date")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("tbl_inventory_check_product");
                });
            ...
            modelBuilder.Entity("eModels.PaymentTypeModel", b =>
                {
                    ...
                    b.Property<bool>("is_single_payment")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("manual_payment_fee")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("payment_fee")
                        .HasColumnType("decimal(19,8)");
            ...
            modelBuilder.Entity("eModels.ProductModel", b =>
                {
                    ...
                    b.Property<string>("block_to_business_branch_ids")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");

                    b.Property<string>("business_branch_ids")
                        .HasColumnType("nvarchar(max)")
                        .UseCollation("Khmer_100_BIN");
                    ...
                    b.Property<Guid?>("revenue_group_id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eModels.RefundTransactionModel", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("coupon_transaction_id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("coupon_transaction_id");

                    b.ToTable("tbl_refund_transaction");
                });
            ...
            modelBuilder.Entity("eModels.SettingModel", b =>
                {
                    ...
                    b.Property<int>("group_sort_order")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eModels.TableModel", b =>
                {
                    ...
                    b.Property<bool>("require_check_in")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("eModels.RefundTransactionModel", b =>
                {
                    b.HasOne("eModels.CouponVoucherTransactionModel", "coupon_transaction")
                        .WithMany("refund_transactions")
                        .HasForeignKey("coupon_transaction_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("coupon_transaction");
                });
            ...
            modelBuilder.Entity("eModels.CouponVoucherTransactionModel", b =>
                {
                    b.Navigation("refund_transactions");
                });
            ...
            modelBuilder.Entity("eModels.InventoryCheckModel", b =>
                {
                    ...
                    b.Navigation("inventory_check_products");
                });
