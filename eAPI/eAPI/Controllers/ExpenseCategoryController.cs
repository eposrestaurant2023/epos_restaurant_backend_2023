...
namespace eAPI.Controllers
{
    ...
    public class ExpenseCategoryController : ODataController
    {
        ...
        public ExpenseCategoryController(ApplicationDbContext _db,IHubContext<ConnectionHub> _hub)
        {
            db = _db;hub = _hub;
        }
        ...
        [HttpPost]
        [Route("delete/{id}")]
        public async Task<ActionResult<eShareModel.ExpenseCategoryModel>> DeleteRecord(Guid id) //Delete
        {
