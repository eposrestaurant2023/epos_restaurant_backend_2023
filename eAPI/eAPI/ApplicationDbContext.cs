...
namespace eAPI
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<BusinessBranchPaymentTypeModel>().HasKey(t => new { t.payment_type_id, t.business_branch_id });
            builder.Entity<BusinessBrachSettingModel>().HasKey(t => new { t.setting_id, t.business_branch_id });
        ...
        public DbSet<BusinessBrachSettingModel> BusinessBrachSettings { get; set; }
