                        ...
                        {  
                            ...
                            switch (action.action)
                            {
                                case "print_request_bill":
                                    ...
                                    await Program.PrintIvoice(action.sale_id, invoice, Program.CashierPrinter, action.copies);
                                    break;

                                case "print_receipt":
                                    ReceiptListModel receipt = Program.ReceiptLists.Where(r => r.ReceiptName.ToLower() == action.receipt_name.ToLower()).FirstOrDefault();
                                    await Program.PrintReceipt(action.sale_id, receipt, Program.CashierPrinter, action.copies);
                                    break;
                                ...
                                case "reprint_receipt":
                                    ...
                                    await Program.PrintReceipt(action.sale_id, reprint_receipt, Program.CashierPrinter, action.copies, true);
                                    break;
                                ...
                                case "print_waiting_order":
                                    ...
                                    await Program.PrintWaitingOrder(action.sale_id, waiting_order, Program.CashierPrinter, action.copies);
                                    break;
